...
## Source code and independent builds

The complete Electron source code for this release is included in this repository. The dependency tree is locked by `package-lock.json`, and the Windows installer can be rebuilt with the documented commands.

See:

- [BUILDING.md](BUILDING.md) for source and installer build instructions;
- [SECURITY.md](SECURITY.md) for unsigned-binary and reporting information;
- [CORE_FREEZE_RECORD.txt](CORE_FREEZE_RECORD.txt) for the frozen motor-core hashes;
- [NOTICE.md](NOTICE.md) for project acknowledgements;
- [NO_LICENSE.md](NO_LICENSE.md) for the current redistribution terms.
